...
Feature: Agent control plane
  ...
  Scenario: Version an agent definition
    ...
    When the user changes instructions, model, skills, or tools
  ...
  Scenario: Validate agent configuration
    When an agent is saved with an unavailable provider, blocked tool, invalid skill, or sandbox policy
