...
const GENERATED_HEADER = 'Code generated by npm run openapi:generate; DO NOT EDIT.'
...
async function checkOutputs(outputs: Map<string, string>) {
  ...
  if (staleFiles.length > 0) {
    throw new Error(`Generated SDK artifacts are stale. Run npm run openapi:generate.\n${staleFiles.join('\n')}`)
  }
}
