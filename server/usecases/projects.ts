...
import type { AuthScope, ProjectListQuery, ProjectRecord } from './ports'
...
export async function createProject(deps: Deps, auth: AuthScope, name: string): Promise<ProjectRecord> {
