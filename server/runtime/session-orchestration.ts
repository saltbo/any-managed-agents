...
// SessionRuntimeError moved to ./session-base; StopSessionResult to
// ./session-lifecycle. Re-exported for the public surface that historically
// lived here (consumed by the SessionRuntimeGateway adapter).
export type {
...
// ./cloud-turn; the stop/archive lifecycle to ./session-lifecycle. Re-exported
// for the public surface that historically lived here (consumed by the gateway
// adapter, runtime-proxy, the http layer, and server/worker).
export {
  appendRuntimeEvent,
  archiveSession,
