...
- `cloud` environments run the selected runtime through AMA-managed Cloudflare infrastructure. `self_hosted` environments run the selected runtime through registered runtime workers.
