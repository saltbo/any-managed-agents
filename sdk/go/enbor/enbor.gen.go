// Package enbor provides primitives to interact with the openapi HTTP API.
//
...
func (e CreateVaultCredentialRequestType) Valid() bool {
	...
	case CreateVaultCredentialRequestTypePrivateKeyJwk:
		return true
	case CreateVaultCredentialRequestTypeRealmrootAgentState:
		return true
...
func (e VaultCredentialSpecType) Valid() bool {
	...
	case VaultCredentialTypePrivateKeyJwk:
		return true
	case VaultCredentialTypeRealmrootAgentState:
		return true
...
func (c *APIClient) UpdateProjectWithBody(ctx context.Context, projectId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *APIClient) UpdateProject(ctx context.Context, projectId string, body UpdateProjectJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
