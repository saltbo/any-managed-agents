 ...
 */
export const readConfigz = <ThrowOnError extends boolean = false>(options?: Options<ReadConfigzData, ThrowOnError>): RequestResult<ReadConfigzResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ReadConfigzResponses, unknown, ThrowOnError>({ url: '/api/v1/configz', ...options });
