...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorResponse | SessionListResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorResponse | SessionListResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | SessionListResponse
     """
