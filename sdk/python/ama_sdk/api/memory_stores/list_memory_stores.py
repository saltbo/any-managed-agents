...
from ...models.list_memory_stores_archived import ListMemoryStoresArchived
...
def _get_kwargs(
    *,
    archived: ListMemoryStoresArchived | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        archived (ListMemoryStoresArchived | Unset): Filter by lifecycle. Defaults to false (live
