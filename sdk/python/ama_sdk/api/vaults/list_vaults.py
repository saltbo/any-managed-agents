...
from ...models.list_vaults_archived import ListVaultsArchived
from ...models.vault_list_response import VaultListResponse
...
def _get_kwargs(
    *,
    archived: ListVaultsArchived | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorResponse | VaultListResponse | None:
    if response.status_code == 200:
        response_200 = VaultListResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorResponse | VaultListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        archived (ListVaultsArchived | Unset): Filter by lifecycle. Defaults to false (live
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | VaultListResponse
     """
