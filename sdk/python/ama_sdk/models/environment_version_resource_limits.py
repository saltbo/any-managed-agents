...
T = TypeVar("T", bound="EnvironmentVersionResourceLimits")



@_attrs_define
class EnvironmentVersionResourceLimits:
    """ 
        Example:
            {'memoryMb': 512}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_version_resource_limits = cls(
            cpu_ms=cpu_ms,
            memory_mb=memory_mb,
            timeout_seconds=timeout_seconds,
        )

        return environment_version_resource_limits
