...
T = TypeVar("T", bound="CreateEnvironmentRequestResourceLimits")



@_attrs_define
class CreateEnvironmentRequestResourceLimits:
    """ 
        Example:
            {'memoryMb': 512}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_environment_request_resource_limits = cls(
            cpu_ms=cpu_ms,
            memory_mb=memory_mb,
            timeout_seconds=timeout_seconds,
        )

        return create_environment_request_resource_limits
