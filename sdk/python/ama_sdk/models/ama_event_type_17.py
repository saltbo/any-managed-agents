...
from ..models.ama_event_type_17_type import AmaEventType17Type
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="AmaEventType17")



@_attrs_define
class AmaEventType17:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ama_event_type_17 = cls(
            type_=type_,
            payload=payload,
            metadata=metadata,
        )

        return ama_event_type_17
