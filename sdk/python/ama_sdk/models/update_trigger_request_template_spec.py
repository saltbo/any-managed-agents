...
if TYPE_CHECKING:
  ...
  from ..models.update_trigger_request_template_spec_env import UpdateTriggerRequestTemplateSpecEnv
...
T = TypeVar("T", bound="UpdateTriggerRequestTemplateSpec")



@_attrs_define
class UpdateTriggerRequestTemplateSpec:
    """ 
        Attributes:
            ...
            env (UpdateTriggerRequestTemplateSpecEnv | Unset):  Example: {'AK_API_URL': 'https://ak.example.com'}.
    ...
    env: UpdateTriggerRequestTemplateSpecEnv | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        env: UpdateTriggerRequestTemplateSpecEnv | Unset
        if isinstance(_env,  Unset):
            env = UNSET
        else:
            env = UpdateTriggerRequestTemplateSpecEnv.from_dict(_env)
        ...
        update_trigger_request_template_spec = cls(
            agent_id=agent_id,
        ...
        return update_trigger_request_template_spec
