...
if TYPE_CHECKING:
  from ..models.create_trigger_request_template_spec_env import CreateTriggerRequestTemplateSpecEnv
...
T = TypeVar("T", bound="CreateTriggerRequestTemplateSpec")



@_attrs_define
class CreateTriggerRequestTemplateSpec:
    """ 
        Attributes:
            ...
            env (CreateTriggerRequestTemplateSpecEnv | Unset):  Example: {'AK_API_URL': 'https://ak.example.com'}.
    ...
    env: CreateTriggerRequestTemplateSpecEnv | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        env: CreateTriggerRequestTemplateSpecEnv | Unset
        if isinstance(_env,  Unset):
            env = UNSET
        else:
            env = CreateTriggerRequestTemplateSpecEnv.from_dict(_env)
        ...
        create_trigger_request_template_spec = cls(
            agent_id=agent_id,
            runtime=runtime,
        ...
        return create_trigger_request_template_spec
