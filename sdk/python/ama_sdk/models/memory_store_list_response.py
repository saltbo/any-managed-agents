...
T = TypeVar("T", bound="MemoryStoreListResponse")
...
class MemoryStoreListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        memory_store_list_response = cls(
            data=data,
            pagination=pagination,
        )


        memory_store_list_response.additional_properties = d
        return memory_store_list_response
