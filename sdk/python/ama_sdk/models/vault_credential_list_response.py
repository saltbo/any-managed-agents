...
T = TypeVar("T", bound="VaultCredentialListResponse")



@_attrs_define
class VaultCredentialListResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vault_credential_list_response = cls(
            data=data,
            pagination=pagination,
        )


        vault_credential_list_response.additional_properties = d
        return vault_credential_list_response
