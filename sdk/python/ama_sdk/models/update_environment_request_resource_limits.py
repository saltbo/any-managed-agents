...
T = TypeVar("T", bound="UpdateEnvironmentRequestResourceLimits")



@_attrs_define
class UpdateEnvironmentRequestResourceLimits:
    """ 
        Example:
            {'memoryMb': 512}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_environment_request_resource_limits = cls(
            cpu_ms=cpu_ms,
            memory_mb=memory_mb,
            timeout_seconds=timeout_seconds,
        )

        return update_environment_request_resource_limits
