...
T = TypeVar("T", bound="UpdateTriggerRequestSpecSourceType1")



@_attrs_define
class UpdateTriggerRequestSpecSourceType1:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_trigger_request_spec_source_type_1.additional_properties = d
        return update_trigger_request_spec_source_type_1
