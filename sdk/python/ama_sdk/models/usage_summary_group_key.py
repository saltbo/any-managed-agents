...
T = TypeVar("T", bound="UsageSummaryGroupKey")



@_attrs_define
class UsageSummaryGroupKey:
    """ 
        Example:
            {'provider': 'workers-ai'}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usage_summary_group_key.additional_properties = additional_properties
        return usage_summary_group_key
