    ...
    <form className="flex flex-col gap-4" onSubmit={onSubmit}>
      <FieldGroup>
        ...
        <Field>
          ...
          <FieldDescription>
            Cloud sessions use managed infrastructure. Self hosted sessions wait for a runner.
          </FieldDescription>
        </Field>
        <Field>
        ...
        <TextField
          ...
          description="JSON configuration passed to the selected environment runtime."
