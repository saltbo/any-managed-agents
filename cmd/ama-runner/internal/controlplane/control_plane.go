...
// RuntimeInventory mirrors ama.RuntimeInventory but uses the v1 `state` field
...
// Client talks to the rewritten /api/v1 self-hosted runner protocol. It
...
func (c *Client) CheckHealth(ctx context.Context) (*ama.Health, error) {
...
func (c *Client) CreateRunner(ctx context.Context, body ama.CreateRunnerRequest) (*ama.Runner, error) {
...
func (c *Client) PutRunnerHeartbeat(ctx context.Context, runnerID string, body PutRunnerHeartbeatRequest) error {
...
func (c *Client) ListAvailableWorkItems(ctx context.Context) ([]WorkItem, error) {
...
func (c *Client) ReadWorkItem(ctx context.Context, workItemID string) (*WorkItem, error) {
...
func (c *Client) CreateLease(ctx context.Context, body CreateLeaseRequest) (*Lease, error) {
	var lease Lease
...
func (c *Client) UpdateLease(ctx context.Context, leaseID string, body UpdateLeaseRequest) (*Lease, error) {
	var lease Lease
...
func (c *Client) CreateSessionEvents(ctx context.Context, sessionID string, events []SessionEvent) error {
