...
func NewRunnerTokenSource(config runnerconfig.Config, httpClient *http.Client) (*RunnerTokenSource, error) {
...
func (s *RunnerTokenSource) refreshLocked(ctx context.Context) (string, error) {
	...
	healthClient := &controlplane.Client{
...
func (s *RunnerTokenSource) needsRefresh(config runnerconfig.SavedRunnerConfig) bool {
